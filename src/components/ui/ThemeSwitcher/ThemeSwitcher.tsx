      ...
      <div className="relative">
        ...
        <div className="absolute top-0 right-0">
          {themes.length && display ? (
            <div
              className={
                'fixed right-0 top-12 z-40 mt-2 h-full w-full origin-top-right bg-accent-0 shadow-lg outline-none lg:absolute lg:h-auto lg:w-56 lg:border lg:border-accent-3 lg:shadow-lg'
              }
            >
              <div className="flex flex-row justify-end px-6 py-2 lg:py-0">
                <button
                  className="lg:hidden"
